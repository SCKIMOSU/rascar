...
from swingTurnModule import leftSwingTurn # student assignment(1)

# =======================================================================
# import rightPointTurn() method in the pointTurnModule 
# =======================================================================
from pointTurnModule import rightPointTurn # student assignment(2)
from pointTurnModule import leftPointTurn  # student assignment(3)
...
from go_any import go_backward_any # student assignment(4)
from go_any import go_forward
from go_any import go_backward  # student assignment(5)
...
SwingPr=90  # student assignment(6)
SwingTr=0.9 # student assignment(7)
